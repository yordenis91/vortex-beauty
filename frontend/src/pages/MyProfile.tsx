  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">Información de tu cuenta y empresa</p>
      </div>
      ...
      <div className="bg-card rounded-lg shadow-md p-6">
        ...
        {!isEditing ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-foreground">Nombre de empresa</label>
              <p className="mt-1 text-foreground font-medium">{companyInfo.name || 'N/A'}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground">Email corporativo</label>
              <p className="mt-1 text-foreground">{companyInfo.email || 'N/A'}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground">Teléfono</label>
              <p className="mt-1 text-foreground">{companyInfo.phone || 'N/A'}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground">Tax ID / RFC</label>
              <p className="mt-1 text-foreground">{companyInfo.taxId || 'N/A'}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground">Dirección</label>
              <p className="mt-1 text-foreground">{companyInfo.address || 'N/A'}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-foreground">Ciudad / País</label>
              <p className="mt-1 text-foreground">{companyInfo.city || 'N/A'}, {companyInfo.country || 'N/A'}</p>
            </div>
          </div>
        ) : (
          <div className="space-y-4">
            <p className="text-muted-foreground text-sm">La edición de perfil está en construcción. Contacta a soporte para cambios.</p>
          </div>
        )}
      </div>
      ...
      {/* Billing Address */}
      <div className="bg-card rounded-lg shadow-md p-6">
        <h3 className="text-lg font-semibold text-foreground mb-4">Dirección de Facturación</h3>
      ...
      {/* Security Section */}
      <div className="bg-card rounded-lg shadow-md p-6">
        <h3 className="text-lg font-semibold text-foreground mb-4">Seguridad</h3>
        <div className="space-y-4">
          <button className="w-full text-left px-4 py-3 border border-border rounded-md hover:bg-muted">
